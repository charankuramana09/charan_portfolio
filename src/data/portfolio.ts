...
export const experience = [
  {
    ...
    companyUrl: "https://www.isigntech.com/",
    bullets: [
    ...
    skills: ["Java", "Spring Boot", "React", "Microservices", "JWT", "Azure"],
  },
  {
  ...
  },
  {
    ...
    location: "Hyderabad, India",
    employmentType: "Full Time",
    companyUrl: "https://www.novactech.com/",
    bullets: [
      "Scrutinized and entered proposals for life insurance applications.",
      "Processed surrender policy entries and dispatched cheques to branches and customers.",
      "Updated assignment entries from policy holders to third parties.",
      "Raised receipts for renewal payment dues and follow-ups.",
      "Handled customer queries regarding policy and surrender details.",
    ],
    skills: ["Data Entry", "Excel", "MIS Reporting", "DBMS", "KYC Verification"],
  },
];
