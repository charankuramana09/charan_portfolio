...
export default function PremiumHero(): JSX.Element {
  ...
  // Split title safely
  const titleWords = hero.title ? hero.title.split(' ') : ["Full", "Stack", "Developer"];
        ...
        <div className="gradient-border rounded-3xl p-1 mx-4 md:mx-0 w-full max-w-6xl">
          ...
          >
            ...
            <div className="flex flex-col justify-center order-2 md:order-1">
              ...
              <motion.p variants={item} className="text-slate-600 dark:text-slate-300 text-lg max-w-lg leading-relaxed mb-8">
                {hero.shortBio}
              </motion.p>
              ...
              <motion.div variants={item} className="flex flex-wrap items-center gap-4 mb-10">
                <motion.button
                  ...
                  className="hire-glow-btn group relative px-8 py-4 bg-gradient-to-r from-indigo-600 via-purple-600 to-indigo-600 bg-[length:200%_auto] animate-gradient-fast rounded-xl text-white font-bold shadow-xl shadow-indigo-500/30 overflow-hidden border border-white/10 w-fit whitespace-nowrap min-w-[180px] focus-ring"
                ...
                >
                  ...
                  <span className="relative flex items-center justify-center gap-2 z-10 tracking-wide">
                    Hire Me <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform duration-300" />
                  </span>
                </motion.button>
                ...
                >
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="px-8 py-4 rounded-xl border border-slate-200 dark:border-white/20 bg-white/50 dark:bg-white/5 backdrop-blur-sm text-slate-700 dark:text-white font-medium hover:border-indigo-400/40 transition-all duration-300 flex items-center gap-2 shadow-lg dark:shadow-black/20"
                  >
              ...
              <motion.div variants={item} className="flex items-center gap-6 text-slate-500 dark:text-slate-400">
                <a
                  href={contact.linkedin}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors transform hover:scale-110 focus-ring rounded p-1"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:text-slate-900 dark:hover:text-white transition-colors transform hover:scale-110 focus-ring rounded p-1"
                ...
                <a
                  ...
                  className="hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors transform hover:scale-110 focus-ring rounded p-1"
                  aria-label="Send Email"
                >
                  <Mail size={24} />
                </a>
                <div className="h-px w-12 bg-slate-300 dark:bg-slate-700/50" aria-hidden="true" />
                <span className="text-sm font-medium tracking-wide">FOLLOW ME</span>
              </motion.div>
            </div>
                  ...
                  <div className="aspect-square rounded-xl overflow-hidden mb-4 bg-slate-100 dark:bg-slate-800 relative group">
                    <img
                      ...
                      onError={(e) => {
                        ...
                        (e.target as HTMLImageElement).src = 'https://ui-avatars.com/api/?name=Charan+Kuramana&background=6366f1&color=fff&size=256';
                      }}
                    />
