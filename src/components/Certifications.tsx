...
export default function Certifications() {
    return (
        <section id="certifications" className="relative min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-900 overflow-hidden py-20">
            {/* Background Glow */}
            ...
            <motion.div
                ...
                whileInView="show"
                viewport={{ once: true }}
                className="relative z-10 max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-12 bg-white/10 dark:bg-black/20 backdrop-blur-xl rounded-3xl p-10 mx-4"
            >
                {/* LEFT CONTENT */}
                <div className="flex flex-col justify-center">
                    ...
                    <motion.h1 variants={item} className="text-4xl md:text-5xl font-bold text-slate-900 dark:text-white leading-tight">
                        Full Stack{' '}
                        <span className="bg-gradient-to-r from-indigo-400 to-emerald-400 bg-clip-text text-transparent">Developer</span>
                    </motion.h1>

                    <motion.p variants={item} className="mt-4 text-slate-700 dark:text-slate-300 max-w-lg leading-relaxed">
