    ...
    return (
        ...
        >
            <div className="hero-veil" aria-hidden>
                <div className="blob blob--indigo blob--float" style={{ width: 360, height: 360, left: -80, top: -60 }} />
                <div className="blob blob--emerald blob--move" style={{ width: 240, height: 240, right: -40, top: 80, opacity: 0.9 }} />
            </div>
